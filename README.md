...
Администрирование группы проекта в социальной сети ВКонтакте (создание постов, дизайна). Исследовательская работа, мониторинг проектов и конкурсов / конференций / и т.д., создание необходимых визуальных элементов.

### Камалетдинов А.А.

Работа над вьювером MPU Cloud и проект GrandLine. Участие в хакатоне.
...
Участвовал в разработке иэтр забора для GrandLine. Составил статью и видеоурок по песочнице для СНТК. Участвовал в хакатоне Autodesk Forge, проект КИМ. Разработка клиентской и серверной частей, 3д-моделирование, монтаж видеоотчетов. Составил учебную статью по C3D Toolkit для wiki.mpu-cloud.ru, смонтировал обучающее видео.

### Алексеев М.

Изучение Three.js, Node.js, TypeScript. Составление руководства для Центра САПР-разработки. Подготовка к созданию учебного курса по Three.js. Просмотр курсов для ускорения их преимуществ и недостатков.
...
Изучала ​​C3D. Участие в информационном отделе.

### Хрусталев Г. 

Менеджмент проектов по веб-разработке студентов 3 курса (181-326). Организация и оптимизация рабочего процесса команды (CarrotWebDev). Ведение отчетности работы команды (CarrotWebDev). Проектирование и интеграция БД в проектах.

### Журавлев М.

Разработка backend для проекта реализованного в рамках хакатона «Лидеры Цифровой Трансформации 2020». Изучение NestJS для дальнейшей разработки приложений. Проектирование и интеграция БД в проектах.

### Хамидех Н.Х.

Разработка интерфейса для проекта реализованного в рамках хакатона «Лидеры Цифровой Трансформации 2020». Изучение Angular и NestJS для дальнейшей разработки приложений.

### Шик И. 

Разработка интерфейса для проекта реализованного в рамках хакатона «Лидеры Цифровой Трансформации 2020». Изучение Angular для дальнейшей разработки приложений.
